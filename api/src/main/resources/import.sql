...
insert into tb_matches(date, result, team1_id, team2_id) values(TIMESTAMP WITH TIME ZONE '2022-10-14T20:50:08Z', 'ND', 1, 2);
...
insert into tb_bets(match_id, user_id, created_at, updated_at, guess)values(1, 1, NOW(), NOW(), 'ND');